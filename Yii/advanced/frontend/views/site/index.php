...
<div class="site-index">
    ...
    <div class="jumbotron">
        <?= Html::img('@web/imgs/icomp.png',['width'=>'400']) ?>

        <p class="lead"><br/><br/>O Instituto de Computação (IComp), antigo Departamento de Ciência da Computação (DCC),  é um instituto acadêmico que agrega os professores da área de computação. Como todo instituto acadêmico o IComp atua no ensino, pesquisa e extensão, além de desempenhar atividades administrativas.
